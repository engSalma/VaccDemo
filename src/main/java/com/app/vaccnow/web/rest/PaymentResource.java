...
/**
 * REST controller for managing {@link com.app.vaccnow.domain.Payment}.
 */
@RestController
@RequestMapping("/api")
public class PaymentResource {
    ...
    public ResponseEntity<PaymentDTO> updatePayment(@RequestBody PaymentDTO paymentDTO) throws URISyntaxException {
        ...
        return ResponseEntity.ok()
            .headers(HeaderUtil.createEntityUpdateAlert(applicationName, false, ENTITY_NAME, paymentDTO.getId()))
            .body(result);
    }
